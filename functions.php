  ...
  */
  ...
  function add_sidebars() {
      ...
      register_sidebar(
          array(
              'id'            => 'classic',
              'name'          => __( 'Classic Sidebar' ),
              'description'   => __( 'A classic left sidebar.' ),
      ...
      register_sidebar(
          array(
              'id'            => 'hidden',
              'name'          => __( 'The hidden right sidebar' ),
              'description'   => __( 'The hidden right sidebar' ),
  ...
  class Mini_Posts extends WP_Widget {
      ...
      public function __construct() {
          parent::__construct(
              'mini_posts', // Base ID
              'Mini_Posts', // Name
              array( 'description' => __( 'Ajoute les mini posts : pages avec image, titre, date et auteur', 'text_domain' ), ) // Arguments
          );
      }
